...
module.exports = class command extends Command {
    constructor(client) {
        super(client, {
            ...
            group: "mod",
            memberName: "gban",
            description: "Bans a user from New Haven County",
    ...
    async run(message, {
        ...
        const MessageReply = await message.reply("Niiice! Let's ban `"+username+"`!")
        ...
        if (CanProcessCommand == true) {
            message.client.request = {
                ...
                CommandData: {Executor: ExecutorData.robloxId, Type: "Ban", Reason: reason, Player: PlayerId},
            }
