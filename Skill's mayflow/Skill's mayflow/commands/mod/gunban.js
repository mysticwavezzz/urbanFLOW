...
module.exports = class command extends Command {
    constructor(client) {
        super(client, {
            ...
            group: "mod",
            memberName: "gunban",
            description: "Unbans a user from New Haven County",
    ...
    async run(message, {
        ...
        const MessageReply = await message.reply("Niiice! Let's unban `"+username+"`!")
        ...
        if (CanProcessCommand == true) {
            message.client.request = {
                ...
                CommandData: {Executor: ExecutorData.robloxId, Type: "Unban", Reason: reason, Player: PlayerId},
            }
